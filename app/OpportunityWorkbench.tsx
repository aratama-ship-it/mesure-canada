...
const copy = {
  fr: {
    ...
    stamp: `${festivalRadar.length} pistes d’appels au Canada, aux États-Unis et à l’international · ${opportunities.length} appels avec financement étudié · ${fundingPrograms.length} programmes de soutien · vérifiés le 24 juillet 2026`,
  ...
  en: {
    ...
    stamp: `${festivalRadar.length} Canada, U.S. + international call routes · ${opportunities.length} calls with funding reviewed · ${fundingPrograms.length} support programs · checked July 24, 2026`,
  ...
  ja: {
    ...
    stamp: `${festivalRadar.length}件のカナダ・米国・国際公募／監視ルート · ${opportunities.length}件の助成照合済み公募 · ${fundingPrograms.length}件の支援制度 · 2026年7月24日確認`,
    baseKicker: "物差しのゼロ地点",
