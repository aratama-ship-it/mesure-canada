...
const copy = {
  fr: {
    ...
    stamp: `${festivalRadar.length} possibilités au Canada, aux États-Unis et à l’international · ${opportunities.length} appels dont le financement a été analysé · ${fundingPrograms.length} programmes de soutien · dernières mises à jour le 5 août 2026`,
  ...
  en: {
    ...
    stamp: `${festivalRadar.length} Canada, U.S. and international opportunity listings · ${opportunities.length} calls with funding links reviewed · ${fundingPrograms.length} support programs · latest updates August 5, 2026`,
  ...
  ja: {
    ...
    stamp: `${festivalRadar.length}件のカナダ・米国・国際公募／監視ルート · ${opportunities.length}件の助成照合済み公募 · ${fundingPrograms.length}件の支援制度 · 最終更新：2026年8月5日`,
    baseKicker: "物差しのゼロ地点",
