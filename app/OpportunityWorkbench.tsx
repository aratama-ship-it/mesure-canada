...
const copy = {
  fr: {
    ...
    stamp: `${opportunities.length} appels liés · ${festivalRadar.length} pistes festivals + marchés · ${fundingPrograms.length} programmes · vérifiés le 22 juillet 2026`,
  ...
  en: {
    ...
    stamp: `${opportunities.length} linked calls · ${festivalRadar.length} festival + market routes · ${fundingPrograms.length} programs · checked July 22, 2026`,
  ...
  ja: {
    ...
    stamp: `${opportunities.length}件の資金連動公募 · ${festivalRadar.length}件のフェス・ショーケースルート · ${fundingPrograms.length}件の制度 · 2026年7月22日確認`,
    baseKicker: "物差しのゼロ地点",
