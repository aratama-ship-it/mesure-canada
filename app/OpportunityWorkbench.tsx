...
type UsRegionKey = "new_york" | "vermont" | "maine" | "new_hampshire" | "massachusetts" | "california" | "chicago_metro" | "illinois_non_chicago" | "austin_msa" | "houston_city" | "texas_other" | "us_new_england_other" | "us_mid_atlantic_other" | "us_midwest" | "us_mid_america" | "us_south" | "us_west";
...
const copy = {
  fr: {
    ...
    eyebrow: "Du Canada et des États-Unis vers les festivals, les diffuseurs et les résidences du monde entier",
    headline: "Découvrez où votre art pourrait vous mener.",
    intro:
      "Explorez des appels vérifiés en cirque, arts de la rue, festivals Fringe, arts de la scène, cinéma, vitrines professionnelles et résidences. Des possibilités de financement sont ensuite proposées, uniquement lorsqu’elles peuvent être étayées par les critères officiels.",
    stamp: `${festivalRadar.length} possibilités au Canada, aux États-Unis et à l’international · ${opportunities.length} appels dont le financement a été analysé · ${fundingPrograms.length} programmes de soutien · dernières mises à jour le 4 septembre 2026`,
    baseKicker: "Votre point de départ",
    baseHeading: "Où résidez-vous actuellement?",
    baseNote: "Votre pays, votre État ou votre province de résidence déterminent les programmes affichés; la nationalité est évaluée séparément.",
    mobileUi: {
    ...
    usBetaNote: "La phase 2 ajoute la Californie, l’Illinois et le Texas. Choisissez la zone la plus précise: certaines enveloppes sont municipales ou excluent le Grand Chicago.",
    ...
    residences: {
      ...
      chicago_metro: "Grand Chicago",
      illinois_non_chicago: "Illinois hors Grand Chicago",
      austin_msa: "Région métropolitaine d’Austin",
      houston_city: "Ville de Houston",
      texas_other: "Texas hors Austin / Houston",
    ...
    provinceHistory: { quebec: "Durée de résidence au Québec — pour vous ou les membres admissibles", ontario: "Durée de résidence en Ontario — pour vous ou les membres admissibles", british_columbia: "Durée de résidence en Colombie-Britannique — pour vous ou les membres admissibles", alberta: "Durée de résidence en Alberta — pour vous ou les membres admissibles", saskatchewan: "Durée de résidence en Saskatchewan — pour vous ou les membres admissibles", manitoba: "Durée de résidence au Manitoba — pour vous ou les membres admissibles", new_brunswick: "Durée de résidence au Nouveau-Brunswick — pour vous ou les membres admissibles", nova_scotia: "Durée de résidence en Nouvelle-Écosse — pour vous ou les membres admissibles", prince_edward_island: "Durée de résidence à l’Île-du-Prince-Édouard — pour vous ou les membres admissibles", newfoundland_labrador: "Durée de résidence à Terre-Neuve-et-Labrador — pour vous ou les membres admissibles", yukon: "Durée de résidence au Yukon — pour vous ou les membres admissibles", northwest_territories: "Durée de résidence aux Territoires du Nord-Ouest — pour vous ou les membres admissibles", nunavut: "Durée de résidence au Nunavut — pour vous ou les membres admissibles", new_york: "Depuis combien de temps résidez-vous dans l’État de New York?", vermont: "Depuis combien de temps résidez-vous au Vermont?", maine: "Depuis combien de temps résidez-vous dans le Maine?", new_hampshire: "Depuis combien de temps résidez-vous au New Hampshire?", massachusetts: "Depuis combien de temps résidez-vous au Massachusetts?", california: "Depuis combien de temps résidez-vous en Californie?", chicago_metro: "Depuis combien de temps résidez-vous en Illinois?", illinois_non_chicago: "Depuis combien de temps résidez-vous en Illinois?", austin_msa: "Depuis combien de temps résidez-vous au Texas?", houston_city: "Depuis combien de temps résidez-vous au Texas?", texas_other: "Depuis combien de temps résidez-vous au Texas?", us_new_england_other: "Depuis combien de temps résidez-vous dans cet État?", us_mid_atlantic_other: "Depuis combien de temps résidez-vous dans cet État ou territoire?", us_midwest: "Depuis combien de temps résidez-vous dans cet État?", us_mid_america: "Depuis combien de temps résidez-vous dans cet État?", us_south: "Depuis combien de temps résidez-vous dans cet État ou territoire?", us_west: "Depuis combien de temps résidez-vous dans cet État ou territoire?" },
    ...
    usPaymentStatus: "Pour la voie destinée aux personnes qui n’ont pas la citoyenneté américaine à Houston, remplissez-vous les trois conditions : SSN actif, compte de chèques américain et capacité à recevoir directement la subvention?",
    ...
    fiscalSponsor: "Avez-vous un organisme américain admissible pouvant agir comme fiscal sponsor?",
    fiscalSponsorNote: "Certains programmes exigent un fiscal sponsor, tandis que d’autres l’interdisent. MESURE évalue chaque règle séparément.",
    privacyNotice: {
    ...
    candidateFilters: {
      heading: "Filtrer les appels",
      statusLabel: "Statut",
      regionLabel: "Région",
      participationLabel: "Accès",
      supportLabel: "Prise en charge",
      sortLabel: "Trier",
      status: { all: "Tous les statuts", active: "Ouverts maintenant", upcoming: "À venir" },
      ...
      support: { all: "Toutes les situations", supported: "Soutien logistique important", conditional: "À décider après vérification", self_funded: "Autofinancement à prévoir", verify: "Contacter l’organisateur", not_direct: "Pas de candidature directe" },
    ...
    candidateCard: { caution: "Élément déterminant", pending: "Les coûts et conditions d’accueil n’ont pas encore été examinés en détail." },
    ...
    showMoreCalls: (count: number, remaining: number) => `Voir ${count} possibilités de plus · ${remaining} restantes`,
    showMoreFunding: (count: number, remaining: number) => `Voir ${count} aides de plus · ${remaining} restantes`,
    radar: {
      kicker: "Radar international",
      heading: "Festivals et marchés à suivre, sans confondre les cycles terminés avec les possibilités actives.",
      intro: "Un registre fondé sur des sources officielles pour le cirque, les arts de la rue, les festivals Fringe, le cinéma et les marchés professionnels. Chaque fiche indique si la possibilité est ouverte, annoncée ou à surveiller.",
      count: "possibilités recensées",
      regions: "régions",
      all: "Tous",
      ...
      noTagResults: "Aucune possibilité vérifiée ne correspond encore à cette catégorie.",
      ...
      candidateSource: "Possibilité active repérée",
      candidateChosen: "Possibilité sélectionnée dans le radar",
      fundingCheck: "Financement à vérifier séparément",
      fundingCheckNote: "Cette possibilité est ouverte ou annoncée, mais ses conditions et ses dépenses ne sont pas assez détaillées pour y associer automatiquement un financement. Vérifiez d’abord l’appel officiel, puis le programme de financement.",
      fundingReviewHeading: "Analyse du financement",
      fundingReviewStatus: {
        suggested: "Possibilités étayées par les critères officiels",
        reviewed_no_match: "Analyse terminée : aucune correspondance suffisamment étayée",
        pending_terms: "En attente de modalités suffisantes",
      },
      fundingSuggested: "Possibilités de financement à envisager sous conditions",
      fundingSuggestedForProfile: "Aucune possibilité analysée ne correspond au profil et au lieu de résidence sélectionnés.",
      fundingReviewed: "Analyse du financement effectuée le",
      fundingLinked: "Financement lié dans la fiche détaillée",
    },
    ...
    decisionLabels: { access: "Possibilité de déposer", applicantCost: "Coûts à assumer", organizerSupport: "Pris en charge par l’organisateur", quebec: "Évaluation selon votre lieu de résidence" },
    practicality: { supported: "Soutien logistique important", conditional: "À décider après vérification", self_funded: "Autofinancement à prévoir", verify: "Contacter d’abord l’organisateur", not_direct: "Pas de candidature directe depuis votre lieu de résidence" },
    decisionGuideNote: "Évaluation de MESURE fondée sur les conditions publiées; elle ne mesure ni la probabilité de sélection ni la qualité artistique.",
    fundingFor: "Programmes directement associés",
    noFunding: "Aucun programme n’est directement lié à cet appel. Les autres programmes accessibles depuis votre lieu de résidence restent visibles ci-dessous, sans laisser entendre qu’un lien a été établi.",
    regionalHeading: "Autres programmes accessibles depuis votre lieu de résidence",
    regionalNote: "Ce programme correspond à votre lieu de résidence et à votre profil, mais n’est pas encore lié à cet appel précis. Vérifiez l’objet du financement avant de l’inclure au budget.",
    ...
    eligibilityReasons: {
      ...
      statusConditional: "Ce statut peut être considéré, sous réserve d’une autorisation valide et des conditions propres au programme.",
      ...
      organizationUnknown: "Le statut de constitution ou d’enregistrement au Canada doit être confirmé.",
      ...
      usPaymentUnknown: "Les conditions de paiement de la voie non-citoyenne de Houston doivent être confirmées.",
      usPaymentMissing: "La voie destinée aux personnes qui n’ont pas la citoyenneté américaine à Houston exige un SSN actif, un compte de chèques américain et la capacité de recevoir directement les fonds.",
    ...
    whyBody: "Les sites officiels font foi. MESURE relie une occasion réelle aux aides accessibles selon le lieu de résidence, le statut, l’historique local et le moment du projet.",
  ...
  en: {
    ...
    eyebrow: "From Canada and the U.S. to festivals, venues and residencies worldwide",
    headline: "Find where your art could go next.",
    intro: "Explore verified opportunities across circus, street arts, Fringe, the performing arts, film, professional showcases and residencies. Potential funding appears only when a connection can be supported by official criteria.",
    stamp: `${festivalRadar.length} Canada, U.S. and international opportunity listings · ${opportunities.length} calls with funding links reviewed · ${fundingPrograms.length} support programs · latest updates September 4, 2026`,
    baseKicker: "Your starting point",
    baseHeading: "Where do you currently live?",
    baseNote: "The programs shown depend on your country, state or province of residence; nationality is assessed separately.",
    mobileUi: {
    ...
    usBetaNote: "Phase 2 adds California, Illinois and Texas. Choose the most precise area: some funds are city-only or exclude the Chicago Metro region.",
    ...
    provinceHistory: { quebec: "Length of residence in Québec — for you or the qualifying members", ontario: "Length of residence in Ontario — for you or the qualifying members", british_columbia: "Length of residence in British Columbia — for you or the qualifying members", alberta: "Length of residence in Alberta — for you or the qualifying members", saskatchewan: "Length of residence in Saskatchewan — for you or the qualifying members", manitoba: "Length of residence in Manitoba — for you or the qualifying members", new_brunswick: "Length of residence in New Brunswick — for you or the qualifying members", nova_scotia: "Length of residence in Nova Scotia — for you or the qualifying members", prince_edward_island: "Length of residence in Prince Edward Island — for you or the qualifying members", newfoundland_labrador: "Length of residence in Newfoundland and Labrador — for you or the qualifying members", yukon: "Length of residence in Yukon — for you or the qualifying members", northwest_territories: "Length of residence in the Northwest Territories — for you or the qualifying members", nunavut: "Length of residence in Nunavut — for you or the qualifying members", new_york: "How long have you lived in New York State?", vermont: "How long have you lived in Vermont?", maine: "How long have you lived in Maine?", new_hampshire: "How long have you lived in New Hampshire?", massachusetts: "How long have you lived in Massachusetts?", california: "How long have you lived in California?", chicago_metro: "How long have you lived in Illinois?", illinois_non_chicago: "How long have you lived in Illinois?", austin_msa: "How long have you lived in Texas?", houston_city: "How long have you lived in Texas?", texas_other: "How long have you lived in Texas?", us_new_england_other: "How long have you lived in this state?", us_mid_atlantic_other: "How long have you lived in this state or territory?", us_midwest: "How long have you lived in this state?", us_mid_america: "How long have you lived in this state?", us_south: "How long have you lived in this state or territory?", us_west: "How long have you lived in this state or territory?" },
    ...
    usPaymentStatus: "For Houston applicants who are not U.S. citizens, can you meet all three conditions: an active SSN, a domestic U.S. checking account and the ability to accept the grant directly?",
    ...
    callsHeading: "Relevant opportunities",
    callsCount: "results",
    candidateFilters: {
      heading: "Filter opportunities",
      statusLabel: "Status",
      regionLabel: "Region",
      participationLabel: "Application method",
      supportLabel: "Practical support",
      sortLabel: "Sort",
      ...
      participation: { all: "All application methods", international: "International applicants accepted", open_access: "Open access", selection: "Selection required", conditions: "Regional or language conditions" },
      support: { all: "All practical situations", supported: "Strong logistical support", conditional: "Decide after checking", self_funded: "Self-funding required", verify: "Contact the organizer", not_direct: "No direct application" },
    ...
    candidateCard: { caution: "Key consideration", pending: "Costs and hosting conditions have not yet been reviewed in detail." },
    ...
    radar: {
      ...
      heading: "Festivals and markets to follow—without treating closed cycles as current opportunities.",
      intro: "A register based on official sources for circus, street arts, Fringe, film and professional markets. Each entry shows whether the opportunity is open, expected to open or worth monitoring.",
      ...
      noTagResults: "No verified opportunity matches this category yet.",
      participation: { international: "International applicants accepted", open_access: "Open access", selection: "Selection required", regional_conditions: "Local conditions to check", language_conditions: "Language conditions to check", eligibility_check: "Eligibility to confirm" },
      ...
      candidateSource: "Current opportunity from the radar",
      candidateChosen: "Opportunity selected from the radar",
      fundingCheck: "Funding requires a separate check",
      fundingCheckNote: "This opportunity is open or announced, but its conditions and expenses are not detailed enough to link funding automatically. Check the official call first, then the funding program.",
      fundingReviewHeading: "Funding review",
      fundingReviewStatus: {
        suggested: "Potential funding supported by official criteria",
        reviewed_no_match: "Reviewed: no sufficiently supported match found",
        pending_terms: "Waiting for sufficient terms",
      },
      fundingSuggested: "Potential funding to consider under specific conditions",
      fundingSuggestedForProfile: "None of the reviewed programs fits the selected profile and place of residence.",
      fundingReviewed: "Funding review completed",
      fundingLinked: "Funding linked in the detailed listing",
    },
    ...
    decisionLabels: { access: "How to apply", applicantCost: "Costs you cover", organizerSupport: "Organizer support", quebec: "Feasibility from where you live" },
    practicality: { supported: "Notable logistical support", conditional: "Decide after checking", self_funded: "Build a self-funded budget", verify: "Contact the organizer first", not_direct: "No direct application from where you live" },
    decisionGuideNote: "MESURE’s assessment is based on published terms; it does not score selection odds or artistic quality.",
    fundingFor: "Directly linked programs",
    noFunding: "No program is directly linked to this call. Other programs available where you live remain visible below, without implying a connection.",
    regionalHeading: "Other programs available where you live",
    regionalNote: "This program fits your place of residence and profile but is not yet linked to this specific call. Check its funding purpose before adding it to the budget.",
    ...
    whyBody: "Official websites remain authoritative. MESURE connects a real opportunity with programs based on residence, status, local history and timing.",
  ...
  ja: {
    ...
    stamp: `${festivalRadar.length}件のカナダ・米国・国際公募／監視ルート · ${opportunities.length}件の助成照合済み公募 · ${fundingPrograms.length}件の支援制度 · 最終更新：2026年9月4日`,
    baseKicker: "物差しのゼロ地点",
    ...
    usBetaNote: "第2段階としてカリフォルニア、イリノイ、テキサスを追加しました。市限定やシカゴ都市圏を除く制度があるため、最も近い地域を選んでください。",
    ...
    usPaymentStatus: "ヒューストンの非米国市民ルートで必要な3条件（有効なSSN、米国内の当座預金口座、助成金を直接受領できること）をすべて満たせますか？",
...
const usPriorityResidenceRegions: UsRegionKey[] = ["new_york", "vermont", "maine", "new_hampshire", "massachusetts", "california", "chicago_metro", "illinois_non_chicago", "austin_msa", "houston_city", "texas_other"];
...
const regionByResidence: Record<Residence, RegionKey> = {
  ...
  chicago_metro: "chicago_metro",
  illinois_non_chicago: "illinois_non_chicago",
  austin_msa: "austin_msa",
  houston_city: "houston_city",
  texas_other: "texas_other",
...
export function OpportunityWorkbench() {
  ...
  const [usPaymentStatus, setUsPaymentStatus] = useState<YesNoUnsure>("unsure");
  ...
  const showHoustonPaymentQuestion = profile !== "organization" && residence === "houston_city" && !["citizen", "permanent", "unsure"].includes(legalStatus);
  ...
  const answers = useMemo(() => ({
    ...
    organizationRegistration, fiscalSponsorStatus, sinStatus, usPaymentStatus, canadaArrival, ageBand,
  }), [ageBand, canadaArrival, collectiveComposition, collectiveSize, fiscalSponsorStatus, legalStatus, organizationRegistration, profile, provinceHistory, sinStatus, torontoHistory, usPaymentStatus]);
    ...
    <main className="site-shell">
      ...
      <section className="workbench" aria-label={t.matcherLabel}>
        <aside className="panel panel-profile">
          ...
          {showHoustonPaymentQuestion ? <fieldset className="field-group"><legend>{t.usPaymentStatus}</legend><select className="field-select" value={usPaymentStatus} onChange={(event) => setUsPaymentStatus(event.target.value as YesNoUnsure)}>{yesNoUnsureOptions.map((item) => <option key={item} value={item}>{t.yesNoUnsure[item]}</option>)}</select></fieldset> : null}
